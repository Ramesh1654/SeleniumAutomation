...
public class Testpet {
	...
	public static void main(String[] args) throws Throwable {
		...
		Logger logger = Logger.getLogger("Testpet.class");
		PropertyConfigurator.configure("log4j.properties");

		ExtentTest Test1 = extentreports.createTest("Testcase-1", "Description1");
		Test1.info("URL Launched").addScreenCaptureFromPath(CaptureScreenshot("1.jpg"), "**URL Launched**");
		...
		// Understand the Concept of Below code because using
		// CSSSELECTOR(33&39)&&getAttribute(45)
		...
		// WebElement iFrameElement = driver.findElement(By.cssSelector(".capc-map-embed
		// mode-widget iframe"));
		Thread.sleep(2000);
		...
		/*
		 * for(WebElement stateNames: states) { String _stateNames=
		 * stateNames.getAttribute("id"); System.out.println(_stateNames); }
		 */
		// Giving string to click on the required state
		logger.info("*****Below All States was displayed*****");
		Test1.info("All States Dispalayed")
	    .addScreenCaptureFromPath(CaptureScreenshot("2.jpg"), "**All States Dispalayed**");
		...
		for (WebElement stateelement : states) {
			...
			if (Allstates.equals(Targetstate)) {
				stateelement.click();
				Thread.sleep(2000);
				Test1.info("State Clicked").addScreenCaptureFromPath(CaptureScreenshot("3.jpg"), "**State Clicked**");
